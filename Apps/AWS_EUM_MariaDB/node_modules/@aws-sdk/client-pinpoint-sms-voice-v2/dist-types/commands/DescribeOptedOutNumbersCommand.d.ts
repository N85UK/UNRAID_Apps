...
declare const DescribeOptedOutNumbersCommand_base: {
    new (input: DescribeOptedOutNumbersCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeOptedOutNumbersCommandInput, DescribeOptedOutNumbersCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeOptedOutNumbersCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeOptedOutNumbersCommandInput, DescribeOptedOutNumbersCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
