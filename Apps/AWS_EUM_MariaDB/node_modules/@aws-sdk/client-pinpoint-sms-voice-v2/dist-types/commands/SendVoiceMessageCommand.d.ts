...
declare const SendVoiceMessageCommand_base: {
    new (input: SendVoiceMessageCommandInput): import("@smithy/smithy-client").CommandImpl<SendVoiceMessageCommandInput, SendVoiceMessageCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: SendVoiceMessageCommandInput): import("@smithy/smithy-client").CommandImpl<SendVoiceMessageCommandInput, SendVoiceMessageCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
