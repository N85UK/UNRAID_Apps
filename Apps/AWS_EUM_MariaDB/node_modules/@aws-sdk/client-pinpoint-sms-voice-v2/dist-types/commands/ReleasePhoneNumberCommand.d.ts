...
declare const ReleasePhoneNumberCommand_base: {
    new (input: ReleasePhoneNumberCommandInput): import("@smithy/smithy-client").CommandImpl<ReleasePhoneNumberCommandInput, ReleasePhoneNumberCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ReleasePhoneNumberCommandInput): import("@smithy/smithy-client").CommandImpl<ReleasePhoneNumberCommandInput, ReleasePhoneNumberCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
