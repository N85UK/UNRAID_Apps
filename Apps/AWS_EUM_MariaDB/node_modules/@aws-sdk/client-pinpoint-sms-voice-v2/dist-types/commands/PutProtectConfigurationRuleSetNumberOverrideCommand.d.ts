...
import { PutProtectConfigurationRuleSetNumberOverrideRequest, PutProtectConfigurationRuleSetNumberOverrideResult } from "../models/models_0";
...
declare const PutProtectConfigurationRuleSetNumberOverrideCommand_base: {
    new (input: PutProtectConfigurationRuleSetNumberOverrideCommandInput): import("@smithy/smithy-client").CommandImpl<PutProtectConfigurationRuleSetNumberOverrideCommandInput, PutProtectConfigurationRuleSetNumberOverrideCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutProtectConfigurationRuleSetNumberOverrideCommandInput): import("@smithy/smithy-client").CommandImpl<PutProtectConfigurationRuleSetNumberOverrideCommandInput, PutProtectConfigurationRuleSetNumberOverrideCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutProtectConfigurationRuleSetNumberOverrideCommand extends PutProtectConfigurationRuleSetNumberOverrideCommand_base {
