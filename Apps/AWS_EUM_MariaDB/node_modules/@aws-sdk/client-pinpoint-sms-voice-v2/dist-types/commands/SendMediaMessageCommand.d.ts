...
declare const SendMediaMessageCommand_base: {
    new (input: SendMediaMessageCommandInput): import("@smithy/smithy-client").CommandImpl<SendMediaMessageCommandInput, SendMediaMessageCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: SendMediaMessageCommandInput): import("@smithy/smithy-client").CommandImpl<SendMediaMessageCommandInput, SendMediaMessageCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SendMediaMessageCommand extends SendMediaMessageCommand_base {
