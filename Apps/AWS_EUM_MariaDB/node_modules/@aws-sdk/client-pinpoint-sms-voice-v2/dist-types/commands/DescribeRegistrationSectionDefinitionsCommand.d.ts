...
import { DescribeRegistrationSectionDefinitionsRequest, DescribeRegistrationSectionDefinitionsResult } from "../models/models_0";
...
declare const DescribeRegistrationSectionDefinitionsCommand_base: {
    new (input: DescribeRegistrationSectionDefinitionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeRegistrationSectionDefinitionsCommandInput, DescribeRegistrationSectionDefinitionsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeRegistrationSectionDefinitionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeRegistrationSectionDefinitionsCommandInput, DescribeRegistrationSectionDefinitionsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeRegistrationSectionDefinitionsCommand extends DescribeRegistrationSectionDefinitionsCommand_base {
