...
import { DescribeRegistrationFieldDefinitionsRequest, DescribeRegistrationFieldDefinitionsResult } from "../models/models_0";
...
declare const DescribeRegistrationFieldDefinitionsCommand_base: {
    new (input: DescribeRegistrationFieldDefinitionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeRegistrationFieldDefinitionsCommandInput, DescribeRegistrationFieldDefinitionsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeRegistrationFieldDefinitionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeRegistrationFieldDefinitionsCommandInput, DescribeRegistrationFieldDefinitionsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeRegistrationFieldDefinitionsCommand extends DescribeRegistrationFieldDefinitionsCommand_base {
