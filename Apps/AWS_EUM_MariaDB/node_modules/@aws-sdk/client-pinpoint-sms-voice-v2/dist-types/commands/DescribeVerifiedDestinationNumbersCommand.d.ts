...
import { DescribeVerifiedDestinationNumbersRequest, DescribeVerifiedDestinationNumbersResult } from "../models/models_0";
...
declare const DescribeVerifiedDestinationNumbersCommand_base: {
    new (input: DescribeVerifiedDestinationNumbersCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeVerifiedDestinationNumbersCommandInput, DescribeVerifiedDestinationNumbersCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVerifiedDestinationNumbersCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeVerifiedDestinationNumbersCommandInput, DescribeVerifiedDestinationNumbersCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeVerifiedDestinationNumbersCommand extends DescribeVerifiedDestinationNumbersCommand_base {
