...
declare const DisassociateOriginationIdentityCommand_base: {
    new (input: DisassociateOriginationIdentityCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateOriginationIdentityCommandInput, DisassociateOriginationIdentityCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DisassociateOriginationIdentityCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateOriginationIdentityCommandInput, DisassociateOriginationIdentityCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateOriginationIdentityCommand extends DisassociateOriginationIdentityCommand_base {
