...
declare const SetDefaultSenderIdCommand_base: {
    new (input: SetDefaultSenderIdCommandInput): import("@smithy/smithy-client").CommandImpl<SetDefaultSenderIdCommandInput, SetDefaultSenderIdCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: SetDefaultSenderIdCommandInput): import("@smithy/smithy-client").CommandImpl<SetDefaultSenderIdCommandInput, SetDefaultSenderIdCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
