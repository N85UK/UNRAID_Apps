...
declare const ListPoolOriginationIdentitiesCommand_base: {
    new (input: ListPoolOriginationIdentitiesCommandInput): import("@smithy/smithy-client").CommandImpl<ListPoolOriginationIdentitiesCommandInput, ListPoolOriginationIdentitiesCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListPoolOriginationIdentitiesCommandInput): import("@smithy/smithy-client").CommandImpl<ListPoolOriginationIdentitiesCommandInput, ListPoolOriginationIdentitiesCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListPoolOriginationIdentitiesCommand extends ListPoolOriginationIdentitiesCommand_base {
