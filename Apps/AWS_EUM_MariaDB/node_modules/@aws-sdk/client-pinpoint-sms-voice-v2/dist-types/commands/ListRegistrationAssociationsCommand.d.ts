...
declare const ListRegistrationAssociationsCommand_base: {
    new (input: ListRegistrationAssociationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListRegistrationAssociationsCommandInput, ListRegistrationAssociationsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListRegistrationAssociationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListRegistrationAssociationsCommandInput, ListRegistrationAssociationsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListRegistrationAssociationsCommand extends ListRegistrationAssociationsCommand_base {
