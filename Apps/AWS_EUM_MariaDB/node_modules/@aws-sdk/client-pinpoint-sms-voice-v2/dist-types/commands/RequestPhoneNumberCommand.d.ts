...
declare const RequestPhoneNumberCommand_base: {
    new (input: RequestPhoneNumberCommandInput): import("@smithy/smithy-client").CommandImpl<RequestPhoneNumberCommandInput, RequestPhoneNumberCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: RequestPhoneNumberCommandInput): import("@smithy/smithy-client").CommandImpl<RequestPhoneNumberCommandInput, RequestPhoneNumberCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
