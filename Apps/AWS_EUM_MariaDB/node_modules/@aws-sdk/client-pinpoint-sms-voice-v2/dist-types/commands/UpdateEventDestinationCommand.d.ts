...
declare const UpdateEventDestinationCommand_base: {
    new (input: UpdateEventDestinationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateEventDestinationCommandInput, UpdateEventDestinationCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateEventDestinationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateEventDestinationCommandInput, UpdateEventDestinationCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
