...
import { DeleteProtectConfigurationRuleSetNumberOverrideRequest, DeleteProtectConfigurationRuleSetNumberOverrideResult } from "../models/models_0";
...
declare const DeleteProtectConfigurationRuleSetNumberOverrideCommand_base: {
    new (input: DeleteProtectConfigurationRuleSetNumberOverrideCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteProtectConfigurationRuleSetNumberOverrideCommandInput, DeleteProtectConfigurationRuleSetNumberOverrideCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteProtectConfigurationRuleSetNumberOverrideCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteProtectConfigurationRuleSetNumberOverrideCommandInput, DeleteProtectConfigurationRuleSetNumberOverrideCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteProtectConfigurationRuleSetNumberOverrideCommand extends DeleteProtectConfigurationRuleSetNumberOverrideCommand_base {
