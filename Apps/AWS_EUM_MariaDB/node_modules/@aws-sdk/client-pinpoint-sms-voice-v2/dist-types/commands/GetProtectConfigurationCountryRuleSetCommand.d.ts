...
import { GetProtectConfigurationCountryRuleSetRequest, GetProtectConfigurationCountryRuleSetResult } from "../models/models_0";
...
declare const GetProtectConfigurationCountryRuleSetCommand_base: {
    new (input: GetProtectConfigurationCountryRuleSetCommandInput): import("@smithy/smithy-client").CommandImpl<GetProtectConfigurationCountryRuleSetCommandInput, GetProtectConfigurationCountryRuleSetCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetProtectConfigurationCountryRuleSetCommandInput): import("@smithy/smithy-client").CommandImpl<GetProtectConfigurationCountryRuleSetCommandInput, GetProtectConfigurationCountryRuleSetCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetProtectConfigurationCountryRuleSetCommand extends GetProtectConfigurationCountryRuleSetCommand_base {
