...
declare const DescribeRegistrationFieldValuesCommand_base: {
    new (input: DescribeRegistrationFieldValuesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeRegistrationFieldValuesCommandInput, DescribeRegistrationFieldValuesCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeRegistrationFieldValuesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeRegistrationFieldValuesCommandInput, DescribeRegistrationFieldValuesCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeRegistrationFieldValuesCommand extends DescribeRegistrationFieldValuesCommand_base {
