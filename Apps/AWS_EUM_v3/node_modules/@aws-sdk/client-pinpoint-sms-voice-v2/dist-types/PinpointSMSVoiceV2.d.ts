...
export interface PinpointSMSVoiceV2 {
     ...
     */
    associateOriginationIdentity(args: AssociateOriginationIdentityCommandInput, options?: __HttpHandlerOptions): Promise<AssociateOriginationIdentityCommandOutput>;
     ...
     */
    createOptOutList(args: CreateOptOutListCommandInput, options?: __HttpHandlerOptions): Promise<CreateOptOutListCommandOutput>;
    ...
    createProtectConfiguration(args: CreateProtectConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<CreateProtectConfigurationCommandOutput>;
    createProtectConfiguration(args: CreateProtectConfigurationCommandInput, cb: (err: any, data?: CreateProtectConfigurationCommandOutput) => void): void;
    createProtectConfiguration(args: CreateProtectConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateProtectConfigurationCommandOutput) => void): void;
    /**
     * @see {@link CreateRegistrationCommand}
     */
    createRegistration(args: CreateRegistrationCommandInput, options?: __HttpHandlerOptions): Promise<CreateRegistrationCommandOutput>;
    createRegistration(args: CreateRegistrationCommandInput, cb: (err: any, data?: CreateRegistrationCommandOutput) => void): void;
    createRegistration(args: CreateRegistrationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateRegistrationCommandOutput) => void): void;
    /**
     * @see {@link CreateRegistrationAssociationCommand}
     */
    createRegistrationAssociation(args: CreateRegistrationAssociationCommandInput, options?: __HttpHandlerOptions): Promise<CreateRegistrationAssociationCommandOutput>;
    createRegistrationAssociation(args: CreateRegistrationAssociationCommandInput, cb: (err: any, data?: CreateRegistrationAssociationCommandOutput) => void): void;
    createRegistrationAssociation(args: CreateRegistrationAssociationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateRegistrationAssociationCommandOutput) => void): void;
    /**
     ...
     */
    createRegistrationVersion(args: CreateRegistrationVersionCommandInput, options?: __HttpHandlerOptions): Promise<CreateRegistrationVersionCommandOutput>;
    createRegistrationVersion(args: CreateRegistrationVersionCommandInput, cb: (err: any, data?: CreateRegistrationVersionCommandOutput) => void): void;
    createRegistrationVersion(args: CreateRegistrationVersionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateRegistrationVersionCommandOutput) => void): void;
    /**
     * @see {@link CreateVerifiedDestinationNumberCommand}
     */
    createVerifiedDestinationNumber(args: CreateVerifiedDestinationNumberCommandInput, options?: __HttpHandlerOptions): Promise<CreateVerifiedDestinationNumberCommandOutput>;
    createVerifiedDestinationNumber(args: CreateVerifiedDestinationNumberCommandInput, cb: (err: any, data?: CreateVerifiedDestinationNumberCommandOutput) => void): void;
    createVerifiedDestinationNumber(args: CreateVerifiedDestinationNumberCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateVerifiedDestinationNumberCommandOutput) => void): void;
    /**
    ...
    deleteAccountDefaultProtectConfiguration(args: DeleteAccountDefaultProtectConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<DeleteAccountDefaultProtectConfigurationCommandOutput>;
    deleteAccountDefaultProtectConfiguration(args: DeleteAccountDefaultProtectConfigurationCommandInput, cb: (err: any, data?: DeleteAccountDefaultProtectConfigurationCommandOutput) => void): void;
    deleteAccountDefaultProtectConfiguration(args: DeleteAccountDefaultProtectConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteAccountDefaultProtectConfigurationCommandOutput) => void): void;
    /**
     ...
     */
    deleteDefaultMessageType(args: DeleteDefaultMessageTypeCommandInput, options?: __HttpHandlerOptions): Promise<DeleteDefaultMessageTypeCommandOutput>;
     ...
     */
    deleteDefaultSenderId(args: DeleteDefaultSenderIdCommandInput, options?: __HttpHandlerOptions): Promise<DeleteDefaultSenderIdCommandOutput>;
    ...
    deleteMediaMessageSpendLimitOverride(args: DeleteMediaMessageSpendLimitOverrideCommandInput, options?: __HttpHandlerOptions): Promise<DeleteMediaMessageSpendLimitOverrideCommandOutput>;
    deleteMediaMessageSpendLimitOverride(args: DeleteMediaMessageSpendLimitOverrideCommandInput, cb: (err: any, data?: DeleteMediaMessageSpendLimitOverrideCommandOutput) => void): void;
    deleteMediaMessageSpendLimitOverride(args: DeleteMediaMessageSpendLimitOverrideCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteMediaMessageSpendLimitOverrideCommandOutput) => void): void;
    /**
     * @see {@link DeleteOptedOutNumberCommand}
     */
    deleteOptedOutNumber(args: DeleteOptedOutNumberCommandInput, options?: __HttpHandlerOptions): Promise<DeleteOptedOutNumberCommandOutput>;
     ...
     */
    deleteOptOutList(args: DeleteOptOutListCommandInput, options?: __HttpHandlerOptions): Promise<DeleteOptOutListCommandOutput>;
     ...
     */
    deleteProtectConfiguration(args: DeleteProtectConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<DeleteProtectConfigurationCommandOutput>;
    deleteProtectConfiguration(args: DeleteProtectConfigurationCommandInput, cb: (err: any, data?: DeleteProtectConfigurationCommandOutput) => void): void;
    deleteProtectConfiguration(args: DeleteProtectConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteProtectConfigurationCommandOutput) => void): void;
    /**
     * @see {@link DeleteProtectConfigurationRuleSetNumberOverrideCommand}
     */
    deleteProtectConfigurationRuleSetNumberOverride(args: DeleteProtectConfigurationRuleSetNumberOverrideCommandInput, options?: __HttpHandlerOptions): Promise<DeleteProtectConfigurationRuleSetNumberOverrideCommandOutput>;
    deleteProtectConfigurationRuleSetNumberOverride(args: DeleteProtectConfigurationRuleSetNumberOverrideCommandInput, cb: (err: any, data?: DeleteProtectConfigurationRuleSetNumberOverrideCommandOutput) => void): void;
    deleteProtectConfigurationRuleSetNumberOverride(args: DeleteProtectConfigurationRuleSetNumberOverrideCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteProtectConfigurationRuleSetNumberOverrideCommandOutput) => void): void;
    /**
     * @see {@link DeleteRegistrationCommand}
     */
    deleteRegistration(args: DeleteRegistrationCommandInput, options?: __HttpHandlerOptions): Promise<DeleteRegistrationCommandOutput>;
    deleteRegistration(args: DeleteRegistrationCommandInput, cb: (err: any, data?: DeleteRegistrationCommandOutput) => void): void;
    deleteRegistration(args: DeleteRegistrationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteRegistrationCommandOutput) => void): void;
    /**
     * @see {@link DeleteRegistrationAttachmentCommand}
     */
    deleteRegistrationAttachment(args: DeleteRegistrationAttachmentCommandInput, options?: __HttpHandlerOptions): Promise<DeleteRegistrationAttachmentCommandOutput>;
    deleteRegistrationAttachment(args: DeleteRegistrationAttachmentCommandInput, cb: (err: any, data?: DeleteRegistrationAttachmentCommandOutput) => void): void;
    deleteRegistrationAttachment(args: DeleteRegistrationAttachmentCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteRegistrationAttachmentCommandOutput) => void): void;
    /**
     * @see {@link DeleteRegistrationFieldValueCommand}
     */
    deleteRegistrationFieldValue(args: DeleteRegistrationFieldValueCommandInput, options?: __HttpHandlerOptions): Promise<DeleteRegistrationFieldValueCommandOutput>;
    deleteRegistrationFieldValue(args: DeleteRegistrationFieldValueCommandInput, cb: (err: any, data?: DeleteRegistrationFieldValueCommandOutput) => void): void;
    deleteRegistrationFieldValue(args: DeleteRegistrationFieldValueCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteRegistrationFieldValueCommandOutput) => void): void;
    /**
     ...
     */
    deleteVerifiedDestinationNumber(args: DeleteVerifiedDestinationNumberCommandInput, options?: __HttpHandlerOptions): Promise<DeleteVerifiedDestinationNumberCommandOutput>;
    deleteVerifiedDestinationNumber(args: DeleteVerifiedDestinationNumberCommandInput, cb: (err: any, data?: DeleteVerifiedDestinationNumberCommandOutput) => void): void;
    deleteVerifiedDestinationNumber(args: DeleteVerifiedDestinationNumberCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteVerifiedDestinationNumberCommandOutput) => void): void;
    /**
     ...
     */
    describeKeywords(args: DescribeKeywordsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeKeywordsCommandOutput>;
     ...
     */
    describeOptedOutNumbers(args: DescribeOptedOutNumbersCommandInput, options?: __HttpHandlerOptions): Promise<DescribeOptedOutNumbersCommandOutput>;
    ...
    describeProtectConfigurations(args: DescribeProtectConfigurationsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeProtectConfigurationsCommandOutput>;
    describeProtectConfigurations(args: DescribeProtectConfigurationsCommandInput, cb: (err: any, data?: DescribeProtectConfigurationsCommandOutput) => void): void;
    describeProtectConfigurations(args: DescribeProtectConfigurationsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeProtectConfigurationsCommandOutput) => void): void;
    /**
     ...
     */
    describeRegistrationFieldDefinitions(args: DescribeRegistrationFieldDefinitionsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeRegistrationFieldDefinitionsCommandOutput>;
    describeRegistrationFieldDefinitions(args: DescribeRegistrationFieldDefinitionsCommandInput, cb: (err: any, data?: DescribeRegistrationFieldDefinitionsCommandOutput) => void): void;
    describeRegistrationFieldDefinitions(args: DescribeRegistrationFieldDefinitionsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeRegistrationFieldDefinitionsCommandOutput) => void): void;
    /**
     * @see {@link DescribeRegistrationFieldValuesCommand}
     */
    describeRegistrationFieldValues(args: DescribeRegistrationFieldValuesCommandInput, options?: __HttpHandlerOptions): Promise<DescribeRegistrationFieldValuesCommandOutput>;
    describeRegistrationFieldValues(args: DescribeRegistrationFieldValuesCommandInput, cb: (err: any, data?: DescribeRegistrationFieldValuesCommandOutput) => void): void;
    describeRegistrationFieldValues(args: DescribeRegistrationFieldValuesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeRegistrationFieldValuesCommandOutput) => void): void;
    /**
     ...
     */
    describeRegistrationSectionDefinitions(args: DescribeRegistrationSectionDefinitionsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeRegistrationSectionDefinitionsCommandOutput>;
    describeRegistrationSectionDefinitions(args: DescribeRegistrationSectionDefinitionsCommandInput, cb: (err: any, data?: DescribeRegistrationSectionDefinitionsCommandOutput) => void): void;
    describeRegistrationSectionDefinitions(args: DescribeRegistrationSectionDefinitionsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeRegistrationSectionDefinitionsCommandOutput) => void): void;
    /**
     ...
     */
    describeRegistrationVersions(args: DescribeRegistrationVersionsCommandInput, options?: __HttpHandlerOptions): Promise<DescribeRegistrationVersionsCommandOutput>;
    describeRegistrationVersions(args: DescribeRegistrationVersionsCommandInput, cb: (err: any, data?: DescribeRegistrationVersionsCommandOutput) => void): void;
    describeRegistrationVersions(args: DescribeRegistrationVersionsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeRegistrationVersionsCommandOutput) => void): void;
    /**
     ...
     */
    disassociateOriginationIdentity(args: DisassociateOriginationIdentityCommandInput, options?: __HttpHandlerOptions): Promise<DisassociateOriginationIdentityCommandOutput>;
     ...
     */
    disassociateProtectConfiguration(args: DisassociateProtectConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<DisassociateProtectConfigurationCommandOutput>;
    disassociateProtectConfiguration(args: DisassociateProtectConfigurationCommandInput, cb: (err: any, data?: DisassociateProtectConfigurationCommandOutput) => void): void;
    disassociateProtectConfiguration(args: DisassociateProtectConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisassociateProtectConfigurationCommandOutput) => void): void;
    /**
     * @see {@link DiscardRegistrationVersionCommand}
     */
    discardRegistrationVersion(args: DiscardRegistrationVersionCommandInput, options?: __HttpHandlerOptions): Promise<DiscardRegistrationVersionCommandOutput>;
    discardRegistrationVersion(args: DiscardRegistrationVersionCommandInput, cb: (err: any, data?: DiscardRegistrationVersionCommandOutput) => void): void;
    discardRegistrationVersion(args: DiscardRegistrationVersionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DiscardRegistrationVersionCommandOutput) => void): void;
    /**
     * @see {@link GetProtectConfigurationCountryRuleSetCommand}
     */
    getProtectConfigurationCountryRuleSet(args: GetProtectConfigurationCountryRuleSetCommandInput, options?: __HttpHandlerOptions): Promise<GetProtectConfigurationCountryRuleSetCommandOutput>;
    getProtectConfigurationCountryRuleSet(args: GetProtectConfigurationCountryRuleSetCommandInput, cb: (err: any, data?: GetProtectConfigurationCountryRuleSetCommandOutput) => void): void;
    getProtectConfigurationCountryRuleSet(args: GetProtectConfigurationCountryRuleSetCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetProtectConfigurationCountryRuleSetCommandOutput) => void): void;
    /**
     ...
     */
    listPoolOriginationIdentities(args: ListPoolOriginationIdentitiesCommandInput, options?: __HttpHandlerOptions): Promise<ListPoolOriginationIdentitiesCommandOutput>;
     ...
     */
    listProtectConfigurationRuleSetNumberOverrides(args: ListProtectConfigurationRuleSetNumberOverridesCommandInput, options?: __HttpHandlerOptions): Promise<ListProtectConfigurationRuleSetNumberOverridesCommandOutput>;
    listProtectConfigurationRuleSetNumberOverrides(args: ListProtectConfigurationRuleSetNumberOverridesCommandInput, cb: (err: any, data?: ListProtectConfigurationRuleSetNumberOverridesCommandOutput) => void): void;
    listProtectConfigurationRuleSetNumberOverrides(args: ListProtectConfigurationRuleSetNumberOverridesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListProtectConfigurationRuleSetNumberOverridesCommandOutput) => void): void;
    /**
     * @see {@link ListRegistrationAssociationsCommand}
     */
    listRegistrationAssociations(args: ListRegistrationAssociationsCommandInput, options?: __HttpHandlerOptions): Promise<ListRegistrationAssociationsCommandOutput>;
    listRegistrationAssociations(args: ListRegistrationAssociationsCommandInput, cb: (err: any, data?: ListRegistrationAssociationsCommandOutput) => void): void;
    listRegistrationAssociations(args: ListRegistrationAssociationsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListRegistrationAssociationsCommandOutput) => void): void;
    /**
     ...
     */
    putMessageFeedback(args: PutMessageFeedbackCommandInput, options?: __HttpHandlerOptions): Promise<PutMessageFeedbackCommandOutput>;
    putMessageFeedback(args: PutMessageFeedbackCommandInput, cb: (err: any, data?: PutMessageFeedbackCommandOutput) => void): void;
    putMessageFeedback(args: PutMessageFeedbackCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PutMessageFeedbackCommandOutput) => void): void;
    /**
     * @see {@link PutOptedOutNumberCommand}
     */
    putOptedOutNumber(args: PutOptedOutNumberCommandInput, options?: __HttpHandlerOptions): Promise<PutOptedOutNumberCommandOutput>;
     ...
     */
    putProtectConfigurationRuleSetNumberOverride(args: PutProtectConfigurationRuleSetNumberOverrideCommandInput, options?: __HttpHandlerOptions): Promise<PutProtectConfigurationRuleSetNumberOverrideCommandOutput>;
    putProtectConfigurationRuleSetNumberOverride(args: PutProtectConfigurationRuleSetNumberOverrideCommandInput, cb: (err: any, data?: PutProtectConfigurationRuleSetNumberOverrideCommandOutput) => void): void;
    putProtectConfigurationRuleSetNumberOverride(args: PutProtectConfigurationRuleSetNumberOverrideCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PutProtectConfigurationRuleSetNumberOverrideCommandOutput) => void): void;
    /**
     * @see {@link PutRegistrationFieldValueCommand}
     */
    putRegistrationFieldValue(args: PutRegistrationFieldValueCommandInput, options?: __HttpHandlerOptions): Promise<PutRegistrationFieldValueCommandOutput>;
    putRegistrationFieldValue(args: PutRegistrationFieldValueCommandInput, cb: (err: any, data?: PutRegistrationFieldValueCommandOutput) => void): void;
    putRegistrationFieldValue(args: PutRegistrationFieldValueCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PutRegistrationFieldValueCommandOutput) => void): void;
    /**
     ...
     */
    releaseSenderId(args: ReleaseSenderIdCommandInput, options?: __HttpHandlerOptions): Promise<ReleaseSenderIdCommandOutput>;
    releaseSenderId(args: ReleaseSenderIdCommandInput, cb: (err: any, data?: ReleaseSenderIdCommandOutput) => void): void;
    releaseSenderId(args: ReleaseSenderIdCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ReleaseSenderIdCommandOutput) => void): void;
    /**
     * @see {@link RequestPhoneNumberCommand}
     */
    requestPhoneNumber(args: RequestPhoneNumberCommandInput, options?: __HttpHandlerOptions): Promise<RequestPhoneNumberCommandOutput>;
     ...
     */
    requestSenderId(args: RequestSenderIdCommandInput, options?: __HttpHandlerOptions): Promise<RequestSenderIdCommandOutput>;
    requestSenderId(args: RequestSenderIdCommandInput, cb: (err: any, data?: RequestSenderIdCommandOutput) => void): void;
    requestSenderId(args: RequestSenderIdCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: RequestSenderIdCommandOutput) => void): void;
    /**
     * @see {@link SendDestinationNumberVerificationCodeCommand}
     */
    sendDestinationNumberVerificationCode(args: SendDestinationNumberVerificationCodeCommandInput, options?: __HttpHandlerOptions): Promise<SendDestinationNumberVerificationCodeCommandOutput>;
    sendDestinationNumberVerificationCode(args: SendDestinationNumberVerificationCodeCommandInput, cb: (err: any, data?: SendDestinationNumberVerificationCodeCommandOutput) => void): void;
    sendDestinationNumberVerificationCode(args: SendDestinationNumberVerificationCodeCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: SendDestinationNumberVerificationCodeCommandOutput) => void): void;
    /**
     * @see {@link SendMediaMessageCommand}
     */
    sendMediaMessage(args: SendMediaMessageCommandInput, options?: __HttpHandlerOptions): Promise<SendMediaMessageCommandOutput>;
    sendMediaMessage(args: SendMediaMessageCommandInput, cb: (err: any, data?: SendMediaMessageCommandOutput) => void): void;
    sendMediaMessage(args: SendMediaMessageCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: SendMediaMessageCommandOutput) => void): void;
    /**
     * @see {@link SendTextMessageCommand}
     */
    sendTextMessage(args: SendTextMessageCommandInput, options?: __HttpHandlerOptions): Promise<SendTextMessageCommandOutput>;
     ...
     */
    setAccountDefaultProtectConfiguration(args: SetAccountDefaultProtectConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<SetAccountDefaultProtectConfigurationCommandOutput>;
    setAccountDefaultProtectConfiguration(args: SetAccountDefaultProtectConfigurationCommandInput, cb: (err: any, data?: SetAccountDefaultProtectConfigurationCommandOutput) => void): void;
    setAccountDefaultProtectConfiguration(args: SetAccountDefaultProtectConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: SetAccountDefaultProtectConfigurationCommandOutput) => void): void;
    /**
     * @see {@link SetDefaultMessageFeedbackEnabledCommand}
     */
    setDefaultMessageFeedbackEnabled(args: SetDefaultMessageFeedbackEnabledCommandInput, options?: __HttpHandlerOptions): Promise<SetDefaultMessageFeedbackEnabledCommandOutput>;
    setDefaultMessageFeedbackEnabled(args: SetDefaultMessageFeedbackEnabledCommandInput, cb: (err: any, data?: SetDefaultMessageFeedbackEnabledCommandOutput) => void): void;
    setDefaultMessageFeedbackEnabled(args: SetDefaultMessageFeedbackEnabledCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: SetDefaultMessageFeedbackEnabledCommandOutput) => void): void;
    /**
     * @see {@link SetDefaultMessageTypeCommand}
     */
    setDefaultMessageType(args: SetDefaultMessageTypeCommandInput, options?: __HttpHandlerOptions): Promise<SetDefaultMessageTypeCommandOutput>;
     ...
     */
    setDefaultSenderId(args: SetDefaultSenderIdCommandInput, options?: __HttpHandlerOptions): Promise<SetDefaultSenderIdCommandOutput>;
     ...
     */
    setMediaMessageSpendLimitOverride(args: SetMediaMessageSpendLimitOverrideCommandInput, options?: __HttpHandlerOptions): Promise<SetMediaMessageSpendLimitOverrideCommandOutput>;
    setMediaMessageSpendLimitOverride(args: SetMediaMessageSpendLimitOverrideCommandInput, cb: (err: any, data?: SetMediaMessageSpendLimitOverrideCommandOutput) => void): void;
    setMediaMessageSpendLimitOverride(args: SetMediaMessageSpendLimitOverrideCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: SetMediaMessageSpendLimitOverrideCommandOutput) => void): void;
    /**
     * @see {@link SetTextMessageSpendLimitOverrideCommand}
     */
    setTextMessageSpendLimitOverride(args: SetTextMessageSpendLimitOverrideCommandInput, options?: __HttpHandlerOptions): Promise<SetTextMessageSpendLimitOverrideCommandOutput>;
     ...
     */
    setVoiceMessageSpendLimitOverride(args: SetVoiceMessageSpendLimitOverrideCommandInput, options?: __HttpHandlerOptions): Promise<SetVoiceMessageSpendLimitOverrideCommandOutput>;
     ...
     */
    submitRegistrationVersion(args: SubmitRegistrationVersionCommandInput, options?: __HttpHandlerOptions): Promise<SubmitRegistrationVersionCommandOutput>;
    submitRegistrationVersion(args: SubmitRegistrationVersionCommandInput, cb: (err: any, data?: SubmitRegistrationVersionCommandOutput) => void): void;
    submitRegistrationVersion(args: SubmitRegistrationVersionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: SubmitRegistrationVersionCommandOutput) => void): void;
    /**
    ...
    updatePool(args: UpdatePoolCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdatePoolCommandOutput) => void): void;
    /**
     * @see {@link UpdateProtectConfigurationCommand}
     */
    updateProtectConfiguration(args: UpdateProtectConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<UpdateProtectConfigurationCommandOutput>;
    updateProtectConfiguration(args: UpdateProtectConfigurationCommandInput, cb: (err: any, data?: UpdateProtectConfigurationCommandOutput) => void): void;
    updateProtectConfiguration(args: UpdateProtectConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateProtectConfigurationCommandOutput) => void): void;
    /**
     * @see {@link UpdateProtectConfigurationCountryRuleSetCommand}
     */
    updateProtectConfigurationCountryRuleSet(args: UpdateProtectConfigurationCountryRuleSetCommandInput, options?: __HttpHandlerOptions): Promise<UpdateProtectConfigurationCountryRuleSetCommandOutput>;
    updateProtectConfigurationCountryRuleSet(args: UpdateProtectConfigurationCountryRuleSetCommandInput, cb: (err: any, data?: UpdateProtectConfigurationCountryRuleSetCommandOutput) => void): void;
    updateProtectConfigurationCountryRuleSet(args: UpdateProtectConfigurationCountryRuleSetCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateProtectConfigurationCountryRuleSetCommandOutput) => void): void;
    /**
     * @see {@link UpdateSenderIdCommand}
     */
    updateSenderId(args: UpdateSenderIdCommandInput, options?: __HttpHandlerOptions): Promise<UpdateSenderIdCommandOutput>;
    updateSenderId(args: UpdateSenderIdCommandInput, cb: (err: any, data?: UpdateSenderIdCommandOutput) => void): void;
    updateSenderId(args: UpdateSenderIdCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateSenderIdCommandOutput) => void): void;
    /**
     * @see {@link VerifyDestinationNumberCommand}
     */
    verifyDestinationNumber(args: VerifyDestinationNumberCommandInput, options?: __HttpHandlerOptions): Promise<VerifyDestinationNumberCommandOutput>;
    verifyDestinationNumber(args: VerifyDestinationNumberCommandInput, cb: (err: any, data?: VerifyDestinationNumberCommandOutput) => void): void;
