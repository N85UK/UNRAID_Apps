...
declare const DeleteVerifiedDestinationNumberCommand_base: {
    new (input: DeleteVerifiedDestinationNumberCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVerifiedDestinationNumberCommandInput, DeleteVerifiedDestinationNumberCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteVerifiedDestinationNumberCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVerifiedDestinationNumberCommandInput, DeleteVerifiedDestinationNumberCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
