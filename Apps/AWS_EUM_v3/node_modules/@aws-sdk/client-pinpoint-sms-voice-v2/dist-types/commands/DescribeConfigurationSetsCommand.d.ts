...
declare const DescribeConfigurationSetsCommand_base: {
    new (input: DescribeConfigurationSetsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeConfigurationSetsCommandInput, DescribeConfigurationSetsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeConfigurationSetsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeConfigurationSetsCommandInput, DescribeConfigurationSetsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
