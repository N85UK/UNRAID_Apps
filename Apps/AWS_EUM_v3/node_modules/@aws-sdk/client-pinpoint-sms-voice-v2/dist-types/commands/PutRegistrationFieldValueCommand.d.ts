...
declare const PutRegistrationFieldValueCommand_base: {
    new (input: PutRegistrationFieldValueCommandInput): import("@smithy/smithy-client").CommandImpl<PutRegistrationFieldValueCommandInput, PutRegistrationFieldValueCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutRegistrationFieldValueCommandInput): import("@smithy/smithy-client").CommandImpl<PutRegistrationFieldValueCommandInput, PutRegistrationFieldValueCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
