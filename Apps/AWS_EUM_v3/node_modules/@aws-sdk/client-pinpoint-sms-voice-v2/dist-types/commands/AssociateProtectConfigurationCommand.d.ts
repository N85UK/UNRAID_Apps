...
declare const AssociateProtectConfigurationCommand_base: {
    new (input: AssociateProtectConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateProtectConfigurationCommandInput, AssociateProtectConfigurationCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: AssociateProtectConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateProtectConfigurationCommandInput, AssociateProtectConfigurationCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
