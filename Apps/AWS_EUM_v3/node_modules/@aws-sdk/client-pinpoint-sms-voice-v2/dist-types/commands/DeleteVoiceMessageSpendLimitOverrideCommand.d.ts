...
import { DeleteVoiceMessageSpendLimitOverrideRequest, DeleteVoiceMessageSpendLimitOverrideResult } from "../models/models_0";
...
declare const DeleteVoiceMessageSpendLimitOverrideCommand_base: {
    new (input: DeleteVoiceMessageSpendLimitOverrideCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceMessageSpendLimitOverrideCommandInput, DeleteVoiceMessageSpendLimitOverrideCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DeleteVoiceMessageSpendLimitOverrideCommandInput]): import("@smithy/smithy-client").CommandImpl<DeleteVoiceMessageSpendLimitOverrideCommandInput, DeleteVoiceMessageSpendLimitOverrideCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
