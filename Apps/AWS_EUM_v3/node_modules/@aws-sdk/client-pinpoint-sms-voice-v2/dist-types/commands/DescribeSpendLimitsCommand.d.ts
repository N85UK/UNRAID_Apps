...
declare const DescribeSpendLimitsCommand_base: {
    new (input: DescribeSpendLimitsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSpendLimitsCommandInput, DescribeSpendLimitsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSpendLimitsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeSpendLimitsCommandInput, DescribeSpendLimitsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeSpendLimitsCommand extends DescribeSpendLimitsCommand_base {
