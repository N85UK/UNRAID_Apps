...
declare const SetDefaultMessageTypeCommand_base: {
    new (input: SetDefaultMessageTypeCommandInput): import("@smithy/smithy-client").CommandImpl<SetDefaultMessageTypeCommandInput, SetDefaultMessageTypeCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: SetDefaultMessageTypeCommandInput): import("@smithy/smithy-client").CommandImpl<SetDefaultMessageTypeCommandInput, SetDefaultMessageTypeCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
