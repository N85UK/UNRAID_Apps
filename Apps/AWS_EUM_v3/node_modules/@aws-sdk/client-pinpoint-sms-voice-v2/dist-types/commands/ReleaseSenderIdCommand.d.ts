...
declare const ReleaseSenderIdCommand_base: {
    new (input: ReleaseSenderIdCommandInput): import("@smithy/smithy-client").CommandImpl<ReleaseSenderIdCommandInput, ReleaseSenderIdCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ReleaseSenderIdCommandInput): import("@smithy/smithy-client").CommandImpl<ReleaseSenderIdCommandInput, ReleaseSenderIdCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
