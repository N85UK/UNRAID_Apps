...
declare const DeleteProtectConfigurationCommand_base: {
    new (input: DeleteProtectConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteProtectConfigurationCommandInput, DeleteProtectConfigurationCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteProtectConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteProtectConfigurationCommandInput, DeleteProtectConfigurationCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
