...
import { DescribeRegistrationTypeDefinitionsRequest, DescribeRegistrationTypeDefinitionsResult } from "../models/models_0";
...
declare const DescribeRegistrationTypeDefinitionsCommand_base: {
    new (input: DescribeRegistrationTypeDefinitionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeRegistrationTypeDefinitionsCommandInput, DescribeRegistrationTypeDefinitionsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRegistrationTypeDefinitionsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeRegistrationTypeDefinitionsCommandInput, DescribeRegistrationTypeDefinitionsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeRegistrationTypeDefinitionsCommand extends DescribeRegistrationTypeDefinitionsCommand_base {
