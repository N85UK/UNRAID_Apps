...
import { SendDestinationNumberVerificationCodeRequest, SendDestinationNumberVerificationCodeResult } from "../models/models_0";
...
declare const SendDestinationNumberVerificationCodeCommand_base: {
    new (input: SendDestinationNumberVerificationCodeCommandInput): import("@smithy/smithy-client").CommandImpl<SendDestinationNumberVerificationCodeCommandInput, SendDestinationNumberVerificationCodeCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: SendDestinationNumberVerificationCodeCommandInput): import("@smithy/smithy-client").CommandImpl<SendDestinationNumberVerificationCodeCommandInput, SendDestinationNumberVerificationCodeCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
