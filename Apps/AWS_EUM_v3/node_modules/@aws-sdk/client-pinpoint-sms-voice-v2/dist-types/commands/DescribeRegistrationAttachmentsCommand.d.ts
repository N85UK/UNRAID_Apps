...
declare const DescribeRegistrationAttachmentsCommand_base: {
    new (input: DescribeRegistrationAttachmentsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeRegistrationAttachmentsCommandInput, DescribeRegistrationAttachmentsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRegistrationAttachmentsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeRegistrationAttachmentsCommandInput, DescribeRegistrationAttachmentsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
