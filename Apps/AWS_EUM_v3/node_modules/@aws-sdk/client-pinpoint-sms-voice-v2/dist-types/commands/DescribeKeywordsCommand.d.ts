...
declare const DescribeKeywordsCommand_base: {
    new (input: DescribeKeywordsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeKeywordsCommandInput, DescribeKeywordsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeKeywordsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeKeywordsCommandInput, DescribeKeywordsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
