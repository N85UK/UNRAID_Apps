...
declare const DescribeOptOutListsCommand_base: {
    new (input: DescribeOptOutListsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeOptOutListsCommandInput, DescribeOptOutListsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeOptOutListsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeOptOutListsCommandInput, DescribeOptOutListsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
