...
import { UpdateProtectConfigurationCountryRuleSetRequest, UpdateProtectConfigurationCountryRuleSetResult } from "../models/models_0";
...
declare const UpdateProtectConfigurationCountryRuleSetCommand_base: {
    new (input: UpdateProtectConfigurationCountryRuleSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateProtectConfigurationCountryRuleSetCommandInput, UpdateProtectConfigurationCountryRuleSetCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateProtectConfigurationCountryRuleSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateProtectConfigurationCountryRuleSetCommandInput, UpdateProtectConfigurationCountryRuleSetCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateProtectConfigurationCountryRuleSetCommand extends UpdateProtectConfigurationCountryRuleSetCommand_base {
