...
declare const DescribePoolsCommand_base: {
    new (input: DescribePoolsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribePoolsCommandInput, DescribePoolsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribePoolsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribePoolsCommandInput, DescribePoolsCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
