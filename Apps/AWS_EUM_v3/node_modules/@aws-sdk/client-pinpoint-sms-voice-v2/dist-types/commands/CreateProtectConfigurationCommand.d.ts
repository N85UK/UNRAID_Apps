...
declare const CreateProtectConfigurationCommand_base: {
    new (input: CreateProtectConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateProtectConfigurationCommandInput, CreateProtectConfigurationCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [CreateProtectConfigurationCommandInput]): import("@smithy/smithy-client").CommandImpl<CreateProtectConfigurationCommandInput, CreateProtectConfigurationCommandOutput, PinpointSMSVoiceV2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
